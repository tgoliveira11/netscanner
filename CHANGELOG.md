...
### Changed
- **Topology rebuild** — VLAN-centric tree: pfSense → LAN_INFRA (Ubiquiti) + Compal WiFi APs (MAIN/GUEST/IOT) → clients; solid = wired, dashed = wifi; SSIDs when LuCI reports associations.
