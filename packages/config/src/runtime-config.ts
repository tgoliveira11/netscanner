...
export const CONFIG_FIELDS: ConfigFieldMeta[] = [
  ...
  { key: 'ROUTER_SCRAPE_URL', label: 'Router scrape URL', description: 'Base URL of OpenWrt LuCI or Compal router panel (e.g. http://10.0.40.2).', type: 'string', group: 'Integrations', restartRequired: true },
