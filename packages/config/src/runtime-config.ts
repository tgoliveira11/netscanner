...
export const CONFIG_FIELDS: ConfigFieldMeta[] = [
  ...
  { key: 'NETDISCOVER_ENABLED', label: 'netdiscover ARP', description: 'Passive ARP discovery of quiet hosts (needs netdiscover + root).', type: 'boolean', group: 'Discovery', restartRequired: true },
