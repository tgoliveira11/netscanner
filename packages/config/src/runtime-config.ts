...
export const CONFIG_FIELDS: ConfigFieldMeta[] = [
  ...
  { key: 'SNMP_WIFI_PORTS', label: 'SNMP WiFi ports', description: 'Bridge ports treated as WiFi uplinks.', type: 'string', group: 'Discovery', restartRequired: false },
  ...
  { key: 'ROUTER_SCRAPE_URL', label: 'Router scrape URL', description: 'Base URL of OpenWrt LuCI or Compal router panel (e.g. http://192.168.40.2).', type: 'string', group: 'Integrations', restartRequired: true },
  ...
  { key: 'SCAN_CIDRS', label: 'Extra scan CIDRs', description: 'Comma-separated subnets beyond local interfaces.', type: 'string', group: 'Scanning', restartRequired: false },
